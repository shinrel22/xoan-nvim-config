...
" various color schemes (neovim default is 'dark'; I like 'ceudah' with dark background)
" http://vimcolors.com/
...
" toggle line wrap
nnoremap <silent> <leader>wr :set wrap! wrap?<CR>
...
nnoremap <silent> <leader>cs :nohlsearch<CR><C-L>
...
" change popup selection key to tab
